            ...
            var s = function(w) {
                if (w.code == 1) {
					...
					var n = 0;
                        ...
                        q.parent().prev().html('总共购买：<em class="arial">' + r + '</em>人次/<em class="orange arial">￥' + r*yjg + ".00</em>")
                    }
                }
            };
		...
		var m = function() {
         ...
         //   var r = 0;
            ...
            if (n > 0) {
                ...
                g.children("p").html('总共购买<span class="orange arial z-user">' + n + '</span>个商品  合计金额：<span class="orange arial">' + c + ".00</span> 微币")
            } else {
                g.remove()
            }
        };
