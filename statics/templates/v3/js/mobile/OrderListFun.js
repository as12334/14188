                ...
                function(p) {				 
                    ...
                    if (p.code == 0) {
                        ...
                        for (var l = 0; l < n; l++) {						 
                            ...
                            m += "<li onclick=\"location.href='"+Gobal.Webpath+"/mobile/user/buyDetail/" + o[l].shopid +'\'"><a class="fl z-Limg" href="'+Gobal.Webpath+'/mobile/mobile/item/' + o[l].shopid +'"><img src="' + Gobal.LoadPic + '" src2="'+Gobal.imgpath+'/uploads/' + o[l].thumb + '" border=0 alt=""/></a><div class="u-gds-r gray9"><p class="z-gds-tt"><a href="'+Gobal.Webpath+'/mobile/mobile/item/' + o[l].shopid +'" class="gray6">(第' + o[l].qishu + "期)" + o[l].shopname + '</a></p><p>幸运码：<em class="orange">' + o[l].q_user_code + "</em></p><p>揭晓时间：" + o[l].q_end_time + "</p><p>订单号：" + o[l].code + "</p>";
							
							if (o[l].status == "已付款,已发货,待收货") {

                               m += '<a href="#" style="color:red;">已发货</a> 物流公司 '+ o[l].company +'快递单号 '+ o[l].company_code 
							   
							   } else if (o[l].status == "已付款,未发货,未完成") {
							   m += '<a href="#" style="color:#6F0;">待发货</a>' 	
							   
							   } else if (o[l].status == "已付款,已发货,已完成") {
							   m += '<a href="#" style="color:#06F;">已完成</a>' 	   
