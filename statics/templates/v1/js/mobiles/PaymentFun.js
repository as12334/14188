    ...
    var b = function() {
        ...
        var uu = function() {
            ...
            if (w + g >= x) {
                ...
                s1.unbind("click").addClass("dis");

                if (shopnum != -1) {

                    if (shopnum == 0) {

                        location.replace(Gobal.Webpath+"/mobile/cart/payordersubmit/"+checkpay+"/"+banktype+"/"+x+"/"+t+"/"+submitcode)
                ...
                s1.bind("click", uu).removeClass("dis");
                ...
                if (e > 0) {
                    ...
                    if (v == 1 || v == 2 || v == 3) {
                           ...
                           location.href = Gobal.Webpath+"/mobile/cart/payordersubmit/"+checkpay+"/"+banktype+"/"+x+"/"+t
