...
class  jspage {
	...
	public function config($total,$num,$page,$pageurl=''){		
		...
		$this->jspage=$this->get_url_page($page);
	...
	//	$html.="<li id='Page_One'><a href=\"{$this->url[0]}1{$this->url[1]}\">首页</a></li>";
		$html.="<li id='Page_One'><a href=\"javascript:void(0);\" onclick=\"onpage(1)\">首页</a></li>";
		if($this->jspage==1){
			//$html.="<li id='Page_Prev'><a href=\"{$this->url[0]}".($this->jspage).$this->url[1]."\">上一页</a></li>";
			$html.="<li id='Page_Prev'><a href=\"javascript:void(0);\" >上一页</a></li>";
		}else{
			//$html.="<li id='Page_Prev'><a href=\"{$this->url[0]}".($this->jspage-1).$this->url[1]."\">上一页</a></li>";
			$html.="<li id='Page_Prev'><a href=\"javascript:void(0);\" onclick=\"onpage($this->jspage-1)\">上一页</a></li>";
		}
		for($i=$listnum;$i>=1;$i--){
			$page=$this->jspage-$i;
			...
			if($page<1){
				...
				$html.="<li class='Page_Num'><a href=\"javascript:void(0);\" onclick=\"onpage($page)\">{$page}</a></li>";
			}
			
		}
		
		$html.="<li class='Page_This'>{$this->jspage}</li>";
		...
		if($this->jspage==$this->pagetotal){
		//	$html.="<li id='Page_Next'><a href=\"{$this->url[0]}".($this->jspage).$this->url[1]."\">下一页</a></li>";
			$html.="<li id='Page_Next'><a href=\"javascript:void(0);\">下一页</a></li>";
		}else{
		//	$html.="<li id='Page_Next'><a href=\"{$this->url[0]}".($this->jspage+1).$this->url[1]."\">下一页</a></li>";
			$html.="<li id='Page_Next'><a href=\"javascript:void(0);\" onclick=\"onpage($this->jspage+1)\" >下一页</a></li>";
		}	
		//$html.="<li id='Page_End'><a href=\"{$this->url[0]}{$this->pagetotal}{$this->url[1]}\">尾页</a></li>";
		$html.="<li id='Page_End'><a href=\"javascript:void(0);\" onclick=\"onpage({$this->pagetotal})\" >尾页</a></li>";
		$html_r="</ul>";
