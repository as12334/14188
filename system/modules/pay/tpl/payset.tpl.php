...
<form name="myform" action="" method="post">
  <table width="100%" cellspacing="0">	
		...
		<tr>
			...
			<?php if($pay['pay_class'] == 'tenpay' || $pay['pay_class'] == 'uqdalipay' || $pay['pay_class'] == 'yeepay' || $pay['pay_class'] == 'wapalipay'){ ?>
			<td>
			<input type="radio" name="pay_type" value="1" checked="checked" />及时到帐
			</td>
			<?php } ?>
				<!--<?php if($pay['pay_class'] == 'uqdalipay'){ ?>
			<td>
			<input type="radio" name="pay_type" value="1" checked="checked" />及时到帐
			</td>
			<?php } ?> -->
			...
			<?php if($pay['pay_type'] == '3'){ ?>
			<td>
			<input type="radio" name="pay_type" value="3" checked="checked" />第三方支付
			</td>
			<?php } ?>
			
			
		</tr>
         <?php if($pay['pay_class']=="yunpay"){ 
		 
		 $openurl="http://www.cyh.org.cn/";
		 }elseif($pay['pay_class']=="alipay" || $pay['pay_class']=="wapalipay"){
			 $openurl="https://b.alipay.com/";
		 }elseif($pay['pay_class']=="jubaopay"){
			 $openurl="https://www.jubaopay.com";
		}elseif($pay['pay_class']=="blpay"){
			 $openurl="http://www.hbblkj.com/";
		}elseif($pay['pay_class']=="shan"){
			 $openurl="http://www.passpay.net/";
			 	 	 
		 }else{$openurl="https://mp.weixin.qq.com/";} ?>
        <tr>
			<td width="220" align="right" style="padding-right:5px;">接口申请：</td>
			<td><a href="<?php echo $openurl;?>" target="_blank" style="color:#06F">点击申请</a></td>
		</tr>
