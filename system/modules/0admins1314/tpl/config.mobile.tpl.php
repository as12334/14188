...
<table width="100%" class="meg_table">
    ...
    <tr>
    	<td width="100">短信接口用户名：</td> 
   		<td><input type="text" name="mid" class="input-text wid150" value="<?php echo $mobile['cfg_mobile_3']['mid']; ?>"></td>
    </tr>
    <tr>
	 ...
	 <td>
     <span><?php echo $mobile['cfg_mobile_3']['mobile_text']; ?></span>
     </td>
     </tr>
...
<table width="100%" class="meg_table">
    ...
    <tr>
    	<td width="100">短信接口用户名：</td> 
   		<td><input type="text" name="mid" class="input-text wid150" value="<?php echo $mobile['cfg_mobile_1']['mid']; ?>"></td>
    </tr>
    <tr>
    	<td width="100">短信接口密码：</td> 
   		<td><input type="password" name="mpass" class="input-text wid150"  value="******"></td>
	 ...
	 <td width="100">短信信息：</td>
	 <td>
     <span><?php echo $mobile['cfg_mobile_1']['mobile_text']; ?></span>
     </td>
     </tr>
...
<table width="100%" class="meg_table">
    ...
    <tr>
    	<td width="100">短信接口mid：</td> 
   		<td><input type="text" name="mid" class="input-text wid150"  value="<?php echo $mobile['cfg_mobile_2']['mid']; ?>"></td>
    </tr>
    <tr>
	...
	<tr>
    	<td width="100">短信签名：</td>
   		<td><input type="text" name="mqianming" class="input-text wid150"  value="<?php echo $mobile['cfg_mobile_2']['mqianming']; ?>">
	 ...
	 <td width="100">短信信息：</td>
	 <td>
     <span><?php echo $mobile['cfg_mobile_2']['mobile_text']; ?></span>
     </td>
     </tr>     
