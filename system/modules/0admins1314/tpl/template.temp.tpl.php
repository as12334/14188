...
<table width="100%" class="lr10">
    ...
    <tr>
    	<td width="180" align="right">用户<?php echo $this->_cfg['web_name_two']; ?>获奖邮件模板：</td> 
   		<td><textarea name="e_shop_temp" style=" height:50px; width:450px" class="input-text"><?php echo $temp_e_shop['value']; ?></textarea>
        <font color="red">{用户名}</font> 是用户名称！<font color="red">{中奖码}</font> 是<?php echo $this->_cfg['web_name_two']; ?>码！
        <font color="red">{商品名称}</font> 是<?php echo $this->_cfg['web_name_two']; ?>的商品名称！ 
        </td>
    </tr>
   <tr>
        <td  align="right">用户<?php echo $this->_cfg['web_name_two']; ?>获奖短信模板：</td>
        <td><textarea name="m_shop_temp" style=" height:50px; width:450px" class="input-text"><?php echo $temp_m_shop['value']; ?></textarea>
            <font color="red">00000000</font> 是发送的<?php echo $this->_cfg['web_name_two']; ?>码！,请不要超过70个字,超过按照2条短信发送
        </td>
    </tr>
    <tr>
        <td  align="right">用户短信验证短信模板：</td>
        <td><textarea name="m_reg_temp" style=" height:50px; width:450px" class="input-text"><?php echo $temp_m_reg['value']; ?></textarea>
            <font color="red">000000</font> 是发送的验证码！请不要超过70个字,超过按照2条短信发送</td>
    </tr>
    <tr>
        <td align="right">用户找回密码短信模板：</td>
        <td><textarea name="m_pwd_temp" style=" height:50px; width:450px" class="input-text"><?php echo $temp_m_pwd['value']; ?></textarea>
            <font color="red">000000</font> 是发送的<?php echo $this->_cfg['web_name_two']; ?>码！,请不要超过70个字,超过按照2条短信发送
        </td>
    </tr>
    <tr>
    	<td  align="right">用户邮件验证模板：</td> 
