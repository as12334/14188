...
<!--start-->
		...
		<div class="dingdan_content">
			...
			<li><b class="api_b">商品价格：</b>￥<?php echo $shop['zongrenshu']; ?>.00	</li>
			<li><b class="api_b"><font color="#ff0000">中奖人</font></b><?php echo $qishu['ren']; ?></li>
			<li><b class="api_b"><font color="#ff0000">中奖微购码</font></b><?php echo $qishu['ma']; ?></li>	
			<div class="bk10"></div>
			<li><b class="api_b">购买次数：</b><?php echo $record['gonumber']; ?>人次</li>
			<li class="yun_ma"><b class="api_b">获得微购码：</b><br/>			
			<?php  
