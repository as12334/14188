...
<form method="post" action="#" id="form_post">
	<table width="100%"  cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td><b style="color:red"><?php echo $shopinfo['zongrenshu']; ?></b> <b>人</b> 　　　向上取整(<?php echo $shopinfo['money']; ?> / <?php if($shopinfo['yunjiage']==0){echo 1;}else{ echo $shopinfo['yunjiage']; }?>) = <?php echo $shopinfo['zongrenshu']; ?></td>			
		</tr>
