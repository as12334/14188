...
<form method="post" action="" onSubmit="return CheckForm()">
	<table width="100%"  cellspacing="0" cellpadding="0">
		<tr>
         ...
         <!--<tr>
        	<td align="right" style="width:120px">微商城：</td>
            <td width="900">
			 <input name="orders" value="1" type="checkbox" />&nbsp;<font color="red">同步到微商城</font>&nbsp;&nbsp;
        ...
        <tr>
			...
			<td>
            <input  type="text" id="zhiding"  name="zhiding" class="input-text" style="width:100px; text-align:center" onKeyUp="value=value.replace(/\D/g,'')"> *为空或0表示不指定
           
            </td>
		</tr>
        <tr>      
			<td align="right" style="width:120px">自动约定中奖会员：</td>     
            <td><input type="text" name="auto_money" value="100" class="input-text" style="width:100px; text-align:center" onKeyUp="value=value.replace(/\D/g,'')">当已刷的总数大于多少就自动约定</td>
		</tr> 
          <?php } ?>   
...
<!---------------------->     
		...
		<tr style="background-color:#FFC">
			...
			<td>
				<b>提示：</b> <font color="red">商品总价格请不要填写100，2300,5000这样的整数,整数价格计算出的微购码可能就为10000001</font><br />
    ...
    <tr >
			<td align="right" style="width:120px"></td>
            <td><input type="submit" class="button" name="dosubmit"  value="增加商品" ></td>
