...
<div class="div-user lr10">
    ...
    <span>所属角色: <?php if( $info['mid'] == 0){?>超级管理员<?php }else{ ?>普通管理员<?php } ?></span>
    <span>操作权限: <?php if($info['mid']==0){ echo '<em style="color:red">所有权限</em>';}else{ for($i=0;$i<count($ll);$i++){if($ll[$i]=="0"){echo '<em style="color: #960">系统设置</em>';}if($ll[$i]=="1"){echo ' <em style="color: #0C3">内容管理</em>';}if($ll[$i]=="2"){echo ' <em style="color: #F39">商品管理</em>';}if($ll[$i]=="3"){echo ' <em style="color: #939">用户管理</em>';}if($ll[$i]=="4"){echo ' <em style="color: #ab0">商家管理</em>';}if($ll[$i]=="5"){echo ' <em style="color: #120">界面管理</em>';}if($ll[$i]=="6"){echo ' <em style="color: #923">应用</em>';}if($ll[$i]=="7"){echo ' <em style="color: #9CF">免费抽奖</em>';}if($ll[$i]=="8"){echo ' <em style="color: #88F">订单管理</em>';}}}?></span>
...
<div class="bk15"></div>
	<ul>
        ...
        <?php }?>
        <li><a href="<?php echo G_WEB_PATH; ?>" target="_blank"><img src="<?php echo G_GLOBAL_STYLE; ?>/global/image/btn_60_60_i.png"><span>网站首页</span></a></li>
    ...
    <div class="div-system width30">
        <div class="title">系统信息</div>
            ...
            <ul>        
                ...
                <li><i>站点物理路径：</i><?php echo dirname(dirname(dirname(__FILE__)))?></li>
    ...
    <div class="div-about width30">
        ...
        <ul>
            ...
            <p style="color:#666; padding:20px;font: 12px/1.5 tahoma,arial,宋体b8b\4f53,sans-serif;">
            	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;源码是一款专为一元购系统设计的CMS系统,
                具有商家入驻，视频播放，抽奖，圈子,限时揭晓,晒单等一快钱功能。
            </p> 
    </div>
<!------------>
</div>
