...
<div class="header-title lr10">
	<b>模板管理</b> 
    <span style="color:#f60; padding-left:30px;">谨防模板被盗,建议修改html目录地址，选好模板联系在线客服</span>
</div>
<div class="bk10"></div>
            ...
            <?php } ?>
              ...
              <?php if( $_COOKIE['auid'] == 1){?>		
				 ...
				 [<a  href="<?php echo G_MODULE_PATH; ?>/template/see/<?php echo $temp['dir']."/".$temp['html']; ?>">查看模板</a>]
                    ...
                    [<a  href="javascript:;" onClick="alert('您没有权限哦！');" ><?php echo ($temp['html'] == '未填写') ? "添加" : "修改"; ?></a>]
				 [<a  href="javascript:;" onClick="alert('您没有权限哦！');" >查看模板</a>]
