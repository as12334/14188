...
<table width="100%" class="lr10">
  ...
  <tr>
    <td>邮件服务器</td>
    <td><input type="text" class="input-text" name="server" size="30" value="<?php echo $info['stmp_host'];?>"/>  如果发件人地址是QQ邮箱的话，邮箱服务器就填smtp.qq.com，QQ邮箱需要开启smtp服务，可以在邮箱=》设置=》账户里面开启</td>
  </tr>  
  <tr>
    <td>发件人地址</td>
