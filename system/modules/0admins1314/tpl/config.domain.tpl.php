  ...
  <table width="100%" cellspacing="0">
    <thead>
  	...
  	<tbody id="trlist">
        ...
        <?php }else{ ?>	
        <td width="20%" align="center">
        	<a href="javascript:void(0)" onClick="alert('您没有权限哦！');">修改</a>
            <span class="lr10">|</span>
            <a href="javascript:void(0)" onClick="alert('您没有权限哦！');">删除</a>	        									
        </td>
         <?php } ?>
        </tr>
        <?php } ?>
...
<?php if( $_COOKIE['auid'] == 1){?>
    ...
    <?php }else{ ?>	
    <input type="button" class="button" style=" margin-top:8px; margin-left:20px;" onClick="alert('您没有权限哦！');" name="install1" value=" 添加新的绑定 " />
    <?php } ?>
</div>
