...
$prize_arr = array( 
    ...
    '0' => array('id'=>1,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl0'].'" width="77" height="77" class="boderbb">','num'=>$y1,'v'=>$h1), 
    '1' => array('id'=>2,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl1'].'" width="77" height="77" class="boderbb">','num'=>$y2,'v'=>$h2), 
    '2' => array('id'=>3,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl2'].'" width="77" height="77" class="boderbb">','num'=>$y3,'v'=>$h3), 
    '3' => array('id'=>4,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl3'].'" width="77" height="77" class="boderbb">','num'=>$y4,'v'=>$h4), 
    '4' => array('id'=>5,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl4'].'" width="77" height="77" class="boderbb">','num'=>$y5,'v'=>$h5), 
    '5' => array('id'=>6,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl5'].'" width="77" height="77" class="boderbb">','num'=>$y6,'v'=>$h6), 
	'6' => array('id'=>7,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl6'].'" width="77" height="77" class="boderbb">','num'=>$y7,'v'=>$h7), 
	'7' => array('id'=>8,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl7'].'" width="77" height="77" class="boderbb">','num'=>$y8,'v'=>$h8), 
	'8' => array('id'=>9,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl8'].'" width="77" height="77" class="boderbb">','num'=>$y9,'v'=>$h9), 
	'9' => array('id'=>10,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl9'].'" width="77" height="77" class="boderbb">','num'=>$y10,'v'=>$h10), 
	'10' => array('id'=>11,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl10'].'" width="77" height="77" class="boderbb">','num'=>$y11,'v'=>$h11), 
	'11' => array('id'=>12,'prize'=>'<img src="'.$url.'/'.$rowlp['img_sl11'].'" width="77" height="77" class="boderbb">','num'=>$y12,'v'=>$h12),
