...
$pc = strstr($mystring, $window);
  ...
  if($iPad){$getType="iPad";}
	/* 获取会员登录来源*/	
		...
		$q1 = $this->db->Query("INSERT INTO `@#_member` (`username`,`password`,`img`,`band`,yaoqing,`time`,`getType`) VALUES ('$go_user_name','$go_user_pass','$go_user_img','qq','$yaoqing','$go_user_time','$getType')");
