...
<!-- 内页顶部 -->
    ...
    <header class="g-header">
        ...
        <h2>帐户充值</h2>
        <div class="head-r">
	        <a href="<?php echo WEB_PATH; ?>/mobile/home/userbalance/<?php echo $uids; ?>/" class="z-RCornerBtn"><i></i>帐户明细</a>
        </div>
    </header>

    <div class="g-Total gray9">您的当前余额：<span class="orange arial"><?php echo $member['money']; ?></span>微币</div>
    <section class="clearfix g-member">
        <div class="g-Recharge">
	        <ul id="ulOption">
		        <li money="10"><a href="javascript:;" class="z-sel">10微币<s></s></a></li>
		        <li money="20"><a href="javascript:;">20微币<s></s></a></li>
		        <li money="30"><a href="javascript:;">30微币<s></s></a></li>
		        <li money="100"><a href="javascript:;">100微币<s></s></a></li>
		        <li money="200"><a href="javascript:;">200微币<s></s></a></li>
	    ...
	    <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
		    <ul id="ulBankList">
			    <li class="gray6">选择充值方式<em class="orange">10.00</em>微币</li>
