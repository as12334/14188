...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>
	(第<?php echo $item['qishu']; ?>期)<?php echo $item['title']; ?>
...
<link href="<?php echo G_TEMPLATES_CSS; ?>/weixin/goods.css" rel="stylesheet" type="text/css" />
...
<?php include templates("mobile/index","top");?>
    ...
    <div>
       ...
       <div class="pPic pPicBor">
        ...
        <?php if(($q_showtime=='Y')): ?>
        <!--揭晓倒计时-->
				<?php include templates("mobile/index","item_animation");?>
			<?php  else: ?>
				<?php include templates("mobile/index","item_contents");?>
			<?php endif; ?>
        ...
        <?php if(($q_showtime=='Y')): ?>
			...
			<?php  else: ?>
                ...
                <div class="btn">
                    <ul id='btnBuyBox'>
                        <li  codeid="<?php echo $item['id']; ?>">
                        <a name='buyBox' limitBuy='0' surplus='45' totalnum='59' alreadybuy='14' href="javascript:;" class="orangeBtn buyBtn">立即<?php echo _cfg('web_name_two'); ?></a></li>
                        <li><a href="javascript:;" class="blueBtn addBtn">加入购物车</a></li>
                    </ul>
                </div>
            </div>
