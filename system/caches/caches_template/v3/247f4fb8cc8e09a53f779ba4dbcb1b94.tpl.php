...
<div class="g-purchase-title">
					<span class="gray3"><h2>账户明细</h2></span>
                </div>
	
	<div class="last">
		<ul>
			<li><h3>您的账户可用余额为：</h3><b class="orange"><?php echo $member['money']; ?></b>微币 <a href="<?php echo WEB_PATH; ?>/member/home/userrecharge" class="bluebut" title="充值">充值</a></li>
		</ul>
	</div>
	<div id="divList0" class="list-tab recordList">
	<ul class="listTitle">
		<li class="leftTitle">操作时间</li>
