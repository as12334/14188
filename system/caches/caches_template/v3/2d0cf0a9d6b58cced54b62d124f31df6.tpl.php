...
<script id="pageJS" data="<?php echo G_TEMPLATES_JS; ?>/mobile/consumptionlistFun.js" language="javascript" type="text/javascript"></script>
</head>
<body>
...
<!-- 内页顶部 -->
    ...
    <section class="clearfix g-member">
	    <article class="clearfix m-round g-userMoney">
		    <a href="<?php echo WEB_PATH; ?>/mobile/home/userrecharge/<?php echo $uids; ?>/" class="z-Recharge-btn">去充值</a>可用余额<span class="orange"><?php echo $member['money']; ?></span>微币
	    </article>
