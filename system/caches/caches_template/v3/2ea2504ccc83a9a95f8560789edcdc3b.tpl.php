        ...
        <div class="g-contentCon clrfix">
            ...
            <div class="m-main clrfix">
                ...
                <div class="security-code-con clrfix">
                    <dl>
                        <dt>验证码已发送至<b class="blue"><?php echo $username; ?></b><a id="hylinkRegisterPageA" href="<?php echo WEB_PATH; ?>/member/finduser/findpassword">更换</a></dt>
                        <dd class="code-form">
...
var getAllp = $(function () {
            var base_url = '<?php echo WEB_PATH; ?>/member/user/pcfindAjax/';
    ...
    <script type="text/javascript">
        $(function () {
            var base_url = '<?php echo WEB_PATH; ?>/member/user/Ajaxfindcode/';
            var ehtml = '<i class="passport-icon transparent-png"></i>';
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
							...
							//	$("#btnSubmit").addClass("letter-noSpac").html("提交成功");
                                    location.href = "<?php echo WEB_PATH; ?>/member/user/findok/"+username;
