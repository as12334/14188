...
<div class="g-obtain-title clrfix">
                <ul>
                    <li class="curr"><a href="#">获得的商品</a></li>
...
<div class="R-content">
    ...
    <div class="g-screen-state clrfix">
                        <ul id="ul_state" class="a-screen">
                            <li><a state="0" href="<?php echo WEB_PATH; ?>/member/home/orderlist" <?php if($statusid==''): ?> class="z-checked" <?php endif; ?> >全部</a></li>
                            <!--<li><a state="1" href="javascript:;">待确认地址</a></li> -->
                            <li><a state="2" href="<?php echo WEB_PATH; ?>/member/home/orderlist/2" <?php if($statusid=='2'): ?> class="z-checked" <?php endif; ?>>待发货</a></li>
                            <li><a state="3" href="<?php echo WEB_PATH; ?>/member/home/orderlist/3" <?php if($statusid=='3'): ?> class="z-checked" <?php endif; ?>>待收货</a></li>
                            <!--<li><a state="10" href="javascript:;">待晒单</a></li> -->
                        </ul>
                    </div>

    
	<div class="get-pro gray02">您总共成功<?php echo _cfg('web_name_two'); ?>获得商品 <b id="goodsCount" class="orange"><?php echo count($record); ?></b> 个
