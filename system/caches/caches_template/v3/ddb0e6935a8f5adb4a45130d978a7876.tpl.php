		...
		<ul class="item" id="ulGoodsList">		
			...
			<li class="goods-iten" >
				...
				<div class="Progress-bar">
					<p title="已完成<?php echo percent($shop['canyurenshu'],$shop['zongrenshu']); ?>"><span style="width:<?php if(($shop['canyurenshu'])==0): ?>0<?php  else: ?><?php echo percent($shop['canyurenshu'],$shop['zongrenshu']); ?>;border:1px solid #FF8A00;<?php endif; ?>"></span></p>
					<ul class="Pro-bar-li">
				...
				<div class="gl_buybtn">
					<div class="go_buy">
						<a href="<?php echo WEB_PATH; ?>/goods/<?php echo $shop['id']; ?>" target="_blank" title="立即购买" class="go_Shopping1 fl">立即<?php echo _cfg('web_name_two'); ?></a>
						<span <?php if($shop['yunjiage'] == '0'): ?> style="display:none" <?php endif; ?>><a href="javascript:;" title="加入购物车" class="go_cart fr">加入购物车</a></span>
					</div>
				</div>
