...
<head>
    ...
    <title>找回密码_<?php echo _cfg("web_name"); ?></title>
...
<body>
    <div class="wrapper">
        ...
        <div class="g-logo-top">
            ...
            <span class="fr">想起来了？<a id="hylinkLoginPage" class="blue" href="<?php echo WEB_PATH; ?>/login">立即登录</a></span>
        </div>

        <div class="g-contentCon clrfix">

            <div class="m-main clrfix">
                <h2 class="gray3">设置密码</h2>
                <div class="register-form-con clrfix">
                    <ul><input name="username" type="hidden" id="username" value="<?php echo $username; ?>" />
                ...
                <div class="link-con clrfix">
                    <a id="btn_login" href="javascript:;" class="z-agreeBtn">提交</a>
...
<script type="text/javascript">
        $(function () {
            var base_url = '<?php echo WEB_PATH; ?>/member/user/dopasswordAjax/';
            ...
            $("#btn_login").click(function () {
                if (checkPassword() && checkrePassword()) {
                    ...
                    $.ajax({
                        ...
                        async : true,
		                addidvalue: true,
                        data: {action: 'login_user', username: username, password: password, repassword: repassword},
                    ...
                    $(".wap-tips").html(ehtml + data).show();
							...
							//	$("#btnSubmit").addClass("letter-noSpac").html("提交成功");
                                    location.href = "<?php echo WEB_PATH; ?>/member/user/findok1";
