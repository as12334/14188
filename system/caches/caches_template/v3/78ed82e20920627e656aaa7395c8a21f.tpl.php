...
<!-- 内页顶部 -->
    ...
    <header class="g-header">
        ...
        <div class="head-r">
	        <a href="<?php echo WEB_PATH; ?>/mobile/home/<?php echo $uids; ?>/" class="z-Member"></a>
        </div>
    </header>

    <section class="clearfix g-Record-ct">
		<a class="fl z-Limg" href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $itemlist['0']['id']; ?>/<?php echo $uids; ?>/"><span class="z-Imgbg <?php echo $itemlist['0']['class']; ?>"></span><em class="z-Imgtxt"><?php echo $itemlist['0']['codeState']; ?></em><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $itemlist['0']['thumb']; ?>" border=0 /></a>
