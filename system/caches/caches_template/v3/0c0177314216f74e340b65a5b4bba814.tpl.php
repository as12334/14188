...
<!-- 内页顶部 -->
    ...
    <section class="clearfix g-Cart">
	    <?php if($shop!=0): ?>
	        <article class="clearfix m-round g-Cart-list">
				...
				<?php 
                 ...
                 ?>    
					<li>		            
						<a class="fl u-Cart-img" href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $val['id']; ?>/<?php echo $uids; ?>/">
							<img src="<?php echo G_TEMPLATES_IMAGE; ?>/loading.gif" src2="<?php echo G_UPLOAD_PATH; ?>/<?php echo $val['thumb']; ?>" border="0" alt=""/>
						</a>
						<div class="u-Cart-r">
							<p class="z-Cart-tt"><a href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $val['id']; ?>/<?php echo $uids; ?>/" class="gray6">(第<?php echo $val['qishu']; ?>期)<?php echo $val['title']; ?></a></p>
	    ...
	    <div id="divBtmMoney" class="g-Total-bt"><p>总共<?php echo _cfg('web_name_two'); ?>
			...
			<span class="orange arial"><?php echo $buyshopmoney; ?>.00</span> 微币</p>
