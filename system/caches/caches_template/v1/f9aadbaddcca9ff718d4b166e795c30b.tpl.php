...
<!--<link href="<?php echo G_TEMPLATES_STYLE; ?>/newcss/member_header.css" rel="stylesheet" type="text/css" /> -->
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo G_TEMPLATES_STYLE; ?>/newscss/header.css" />
</head>
                 ...
                 <div class="g-nav">
                     <div class="w1190">
						...
						<?php 							
						 ...
						 ?>	
                                <li>                            
                                    <a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $catelist['cateid']; ?>_0_0" title="<?php echo $catelist['name']; ?>"><?php echo $catelist['name']; ?></a>
                                    <span>
                                    <?php 	
                         ...
                         <div class="nav-main fl">
                             <ul>
                                 <li class="f-nav-home"><a href="<?php echo WEB_PATH; ?>">首页</a></li>
                                 <?php echo Getheader('index'); ?>	
                             </ul>
                         </div>
                         <div id="divHCart" class="nav-cart fr">
                             <div class="nav-cart-btn">
                                 <a href="<?php echo WEB_PATH; ?>/member/cart/cartlist" target="_blank"><i class="f-cart-icon"></i>购物车<span id="spHCart"></span></a>
                             </div>
...
<script language="javascript" type="text/javascript">
             ...
             Base.getScript('<?php echo G_TEMPLATES_JS; ?>/BottomFun.js?v=' + GetVerNum());
          </script>
          <br />
