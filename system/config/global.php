...
if(!file_exists(G_APP_PATH.'system/config/database.inc.php')){
...
define('G_URL_NUMBER',"aHR0cDovL2sua2ltaXdhbmcuY29tL2luZGV4LnR4dA==");
 /*
 *---------------------------------------------------------------
 * UPLOAD URL
 *---------------------------------------------------------------
...
$temp1ates = include("config.inc.php");
