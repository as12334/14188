       ...
       $(".arrow-up").click(function(){
        ...
        var jump_alert = function(){
            ...
            $(".goods-list .btn.gone").click(function(){
                var $goods_li = $(this).parents("li"), content = "", temaiConfirm="";

                if($goods_li.find(".go-quan").length != 0){
					//优惠卷跳出
                    return true;
                }
                ...
                var server_time = $goods_li.attr("ntime");
                //双十二活动期间可以出站
                if((server_time>1418263200)&&(server_time<1418400000)) {
					return true;
				}

                var link = $goods_li.find(".good-title a").attr("href");
                var gid = $goods_li.attr("id");
                var gtype = $goods_li.attr("gtype");
                ...
                if(gtype==3){
                    content = '<div class="top_tips">商品抢光了<p class="tips01">因商品已经抢光，无法再次购买</p><p class="tips01">好商品要眼疾手快！不然就被别人抢走了~</p></div>';
                }else{
                    if($goods_li.find(".j-icon").length){
                	 ...
                	 if($(this).parents("li").find(".like-ico").hasClass("l-active") || $(this).parents("li").find(".del-ico").length != 0){
                         content = '<div class="top_tips">'+desc+'<p class="tips01">因商品已经抢光，'+ temaiConfirm +'</p></div><div class="item-btn clear"><div class="collect-box  fl"><a  gtype="'+gtype+'" data="'+gid+'" class="item-like active" href="javascript:void(0)"> <em class="heart"></em><p class="like-l">已收藏</p></a><p class="like-o"><span class="fl">随时留意您的手机哦</span><a href="'+__URL_JUANPI__+'/apps#jky" target="_blank" class="phone fr">手机端下载</a></p></div></div>';
                     }else{
                         content = '<div class="top_tips">'+desc+'<p class="tips01">因商品已经抢光，'+ temaiConfirm +'</p></div><div class="item-btn clear"><div class="collect-box  fl"><a gtype="'+gtype+'" data="'+gid+'" class="item-like" href="javascript:void(0)"> <em class="heart"></em><p class="like-l">收藏</p></a><p class="like-o"><span class="fl">下次开抢可提醒您</span><a href="'+__URL_JUANPI__+'/apps#jky" target="_blank" class="phone fr">手机端下载</a></p></div></div>';
                     }
                }
