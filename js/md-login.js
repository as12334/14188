...
(function(a) {
    ...
    XD.user_handsome_login_init = function(b) {
        a(".alert_bg").remove();
        var acturl = __URL_MEMBER__ + '/login/index/';
        var quickurl= __URL_MEMBER__+'/quicklogin';
        ...
        f = new XDLightBox({
            ...
            //ifream登录方式
            contentHtml: '<iframe style="width:502px;height:416px;" frameborder="0" scrolling="no"  class="content-landing" src="' + acturl + '?style=2&returnurl='+returnurl+'"></iframe>'
