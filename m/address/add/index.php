                            ...
                            <span class="new-input-span">
                                <span class="new-sel-box new-p-re">
                                    ...
                                    <select style="width:200px;" class="new-select" id="province-select"
                                            data-province="<?php  if($rowaddr['province']=='') {echo "选择省份";}else{echo $rowaddr['province'];}?>">
                                    </select>
                                </span>
                            </span>
                        </span>
                            ...
                            <span class="new-input-span">
                                <span class="new-sel-box new-p-re">
                                    ...
                                    <select style="width:200px;" class="new-select" id="city-select"
                                            data-city="<?php  if($rowaddr['city']=='') {echo "选择城市";}else{echo $rowaddr['city'];}?>">
                                    </select>
                                </span>
                            </span>
                        </span>
                            ...
                            <span class="new-input-span">
                                <span class="new-sel-box new-p-re">
                                    ...
                                    <select style="width:200px;" id="town-select" class="new-select"
                                            data-town="<?php  if($rowaddr['town']=='') {echo "选择区县";}else{echo $rowaddr['town'];}?>">
                                    </select>
                                </span>
                            </span>
                        </span>
            ...
            $("#btn_address").click(function () {
                if (checkUserName() && checkMobile() && checkProvince() && checkCity() && checkAown() && checkAddr()) {
                    ...
                    $.ajax({
                        ...
                        async : true,
		                addidvalue: true,
                        data: {type_address: 'add', username: username, mobile: mobile, province: province,city: city, town: town, addr: addr},
