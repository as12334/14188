...
<?php require"../top.php";?>              <!-- /页头 -->
    ...
    <header id="head" class="head">
        ...
        <span id="user"><a href="<?php echo $url; ?>/?/mobile/mobile" class="btn btn-right btn-sign"></a></span>
    </div>
    </header>
  ...
  <!--  <div class="area">
                <ul class="banner">
                            <?php
	$lm=2;
$sqlcount='select COUNT(*) from `'.$tablepre.'banner` where lm='.$lm.' ';
$counter=$db->getqueryallrow($sqlcount);
$sql='select * from `'.$tablepre.'banner`   where lm='.$lm.' order by id desc';
...
?>
              <li><a href="<?php echo $url; ?>/m">
                             <?php
    if ($img_sl!=''){
        $img_sl=substr($img_sl,0,strrpos($img_sl,'/')+1).'d'.substr($img_sl,strrpos($img_sl,'/')+1);
    ?>
    <img class="lazy"  src="<?php echo $url; ?>/<?php echo $img_sl; ?>">  <?php
    }
    ?>       </a></li>
                <?php }?>
    ...
    <div class="nav_box">
        <nav class="nav" id="nav">
            <ul class="">
            <li><a class="active" href="<?php echo $url; ?>/m"><em class="icon icon-jz"></em><span>商城折扣</span><em class="line"></em></a></li>
            ...
            <li class="_border"><a href="<?php echo $url; ?>/index.php/mobile/lucky/"><em class="icon icon-yg"></em><span>幸运抽奖</span><em class="line"></em></a></li> 
            </ul>
        </nav>
    </div>
<!-- main end-->
...
<script id="goods_show_hidden" type="text/tmpl">
    <li  data_jstype="_taobao_flag_">
        <a class="goods-a" href="_targetUrl_">
            <img class="lazy" _src="_picurl_" src="http://www.kimiwang.com/m/img/kimiblank.gif" width="310">
            _is_new_ _is_over_
        </a>
...
<script id="goods_buy_over_icon_hidden" type="text/tmpl">
    ...
    <a href="<?php echo $url; ?>/m/cart" class="bag-enter"><img src="<?php echo $url; ?>/m/images/icon/bag-icon.png"><?php if($cart->sums()!=''){?> <em><?php echo $cart->sums()?></em><?php }?></a>
