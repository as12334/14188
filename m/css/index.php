...
if (($password) == ($password1) ) {
	$sql='insert into `'.$tablepre.'member_co` (`lm`,`email`,`user`,`password`,`repass`,`mobile`,`img_sl`,`px`,`pass`,`haoping`,`wtime`,`ip`) values(1,"'.$email.'","'.$username.'","'.md5($password).'","'.$password1.'","","'.$img_sl.'",100,"yes","yes",'.time().',"'.$iipp.'")';
mysql_query($sql);
