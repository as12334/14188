...
<body>
    ...
    <header class="head" id="head">
        ...
        <div class="box">
        <ul>
                            <li><a href="<?php echo $url; ?>/m/all/" class="<?php if($arrays['2']=="all"){?> active <?php }?>">全部</a></li>
                            <li><a href="<?php echo $url; ?>/m/fuzhuang" class="<?php if($arrays['2']=="fuzhuang"){?> active <?php }?>">服装</a></li>
                            <li><a href="<?php echo $url; ?>/m/xiebao" class="<?php if($arrays['2']=="xiebao"){?> active <?php }?>">鞋包</a></li>
                            <li><a href="<?php echo $url; ?>/m/muying" class="<?php if($arrays['2']=="muying"){?> active <?php }?>">母婴</a></li>
                            <li><a href="<?php echo $url; ?>/m/jujia" class="<?php if($arrays['2']=="jujia"){?> active <?php }?>">居家</a></li>
                            <li><a href="<?php echo $url; ?>/m/other" class="<?php if($arrays['2']=="other"){?> active <?php }?>">其他</a></li>
                    </ul>
        </div>
    </div>
        <!-- main end-->
...
<script src="<?php echo $url; ?>/m/js/load.js?ts=<?php echo date("YmdHis"); ?>"></script>
